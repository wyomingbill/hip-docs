...
### T02 / D-24 fold-in (backlog #15c) — carried verbatim, decision still open
...
**DECISION FOR BILL (still open, carried forward, not resolved by this
fold-in):** confirm (a) as primary, (b) rejected or fallback-only.
[confirm / choose (b)]
...
- **No mechanically-enforced ratchet taxonomy exists.** (Folded from Phase
  ...
  agreement.
- **T02 remains unresolved.** (Folded fold-in item.) The (a)/(b) decision
  is still open; carried here, not resolved by this reconciliation.
