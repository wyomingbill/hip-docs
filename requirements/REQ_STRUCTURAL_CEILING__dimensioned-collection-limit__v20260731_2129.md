...
section 16: **R29 MET**, **R30 MET**, **R18 NOT MET** (all Bill, 2026-08-01). Their
acceptance rows A29/A30/A18 are wired and passing. Section 16 governs where this line and it
disagree — the header is the older statement. (Qualified D-91; the bare 'acceptance NOT run'
had become false for three rows.) Note A18 passes while R18 is NOT MET: a passing acceptance
row does not carry its requirement.  
**Version:** v20260731_2129 (Mountain Time, per the CLAUDE.md Naming Law)  
**Decision-Owner:** Bill  
**Prepared:** 2026-07-31  
**Filed:** 2026-07-31 (D-70), revised 2026-07-31 (D-71)  
...
### R18 — **NOT MET (Bill's ruling, 2026-08-01)**
