...
Sources
	•	SemiAnalysis on memory share of hyperscaler capex; corroboration via Tom's Hardware.

	•	Reuters on HBM supplier market share (SK Hynix, Micron, Samsung), 2025.

	•	Reuters on Apple, Microsoft, and Dell hardware price increases attributed to AI memory demand, June 2026; trade reporting on console BOM memory share.

	•	Micron Q3 FY2026 earnings materials: revenue, growth, guidance, gross margin, and Strategic Customer Agreement (SCA) structure.

	•	TrendForce / DRAMeXchange memory and storage pricing, June 2026 (DDR5 RDIMM, DDR5 UDIMM, NAND/SSD per-GB); TrendForce on NAND contract price trajectory and HBM-vs-DDR5 profitability.

	•	CXMT scaling commodity DRAM without datacenter HBM (trade reporting).
