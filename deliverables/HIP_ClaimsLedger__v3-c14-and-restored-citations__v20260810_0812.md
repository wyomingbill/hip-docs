...
> **SUPERSEDED by v4 — `HIP_ClaimsLedger__v4-c15-cap-full__v20260810_0848.md` (HA-27,
> 2026-08-10). Recorded reason: "Add C-15 (Bill's wording, 2026-08-10)."** C-01..C-14 wording
> is byte-identical between v3 and v4. Retained unaltered below.

Status: **SUPERSEDED (was: v3)** — original status line preserved verbatim:
"v3 — claim wording drafted by Claude, statuses RULED BY BILL 2026-08-07,
...
Recorded reason for superseding v2: "Add C-14 (Bill's wording, 2026-08-10) and
restore the six dropped evidence citations." No other wording changes.
